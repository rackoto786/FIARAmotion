...
export const MaintenanceChart: React.FC<MaintenanceChartProps> = ({ data = [] }) => {
  return (
    <div className="animate-slide-up" style={{ animationDelay: '0.25s' }}>
      {data.length === 0 ? (
        <div className="h-[300px] flex items-center justify-center text-muted-foreground/30 italic">
          Synchronisation en cours...
        </div>
      ) : (
        <div className="h-[300px] relative">
          <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
            <span className="text-4xl font-black text-foreground vision-text-gradient">
